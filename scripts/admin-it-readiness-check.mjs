...
check('schema160-drift-marker',migration.includes('160::int as expected_schema_version'));
...
check('admin-it-control-readiness-sources', ['v_schema_drift_status','v_admin_schema_preflight_checks','v_admin_deployment_checklist','v_admin_function_readiness_checks','v_production_readiness_checklist','v_admin_backup_restore_rehearsal_directory','v_admin_error_health_center','v_public_seo_smoke_check'].every((value)=>endpoint.includes(value)));
...
check('module-ui-it-assets',moduleUi.includes('/js/it-readiness-ui.js?v=2026-09-01b')&&moduleUi.includes('/it-readiness.css?v=2026-09-01b'));
...
console.log(`Schema 160 I.T. readiness/admin access check: ${passed}/${checks.length} passed\n`);
