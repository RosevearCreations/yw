...
must(hub,['loadBuild341RouteOptimization','/js/admin-route-optimization-ui.js?v=2026-09-23b341',"if (key === 'operations') { loadBuild340CustomerPropertyCRM(); loadBuild341RouteOptimization(); loadBuild342WeatherWorkability(); loadBuild343LandscapeMaterialEstimator(); loadBuild344ChangeOrdersExtras(); loadBuild345QualityControl(); loadBuild346SeasonalOperations(); loadBuild347UniversalActivityTimeline(); loadBuild349SavedViewsSearch(); }"],'Routing lazy load');
must(help,['Build 341 — Route Optimization &amp; Territory Management','advisory','storm-event','dispatch authority'],'Build 341 help');
must(roadmap,['#### **341 — Route Optimization & Territory Management** is implemented','#### **342 — Weather & Workability Controls** is implemented','#### **343 — Landscape Material Estimator** is implemented','next planned autonomous item is **350 — Owner / Management Command Centre**'],'Build 341 roadmap');
