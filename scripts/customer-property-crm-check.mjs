...
must(hub,['loadBuild340CustomerPropertyCRM','/js/admin-customer-property-crm-ui.js?v=2026-09-23b340',"if (key === 'operations') { loadBuild340CustomerPropertyCRM(); loadBuild341RouteOptimization(); }"],'CRM lazy loading');
must(help,['Build 340 — Customer &amp; Property CRM','canonical customer','snow clearing/removal','advisory only'],'Build 340 Help');
must(roadmap,['#### **340 — Customer & Property CRM** is implemented','#### **341 — Route Optimization & Territory Management** is implemented','next planned autonomous item is **342 — Weather & Workability Controls**'],'Build 340 roadmap');
...
must(behavior,['boundary-exact-66-actions','boundary-build340-customer-property-crm'],'Boundary behavior advancement');
