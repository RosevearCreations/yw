...
must(hub,['loadBuild340CustomerPropertyCRM','/js/admin-customer-property-crm-ui.js?v=2026-09-23b340',"if (key === 'operations') { loadBuild340CustomerPropertyCRM(); }"],'CRM lazy loading');
must(help,['Build 340 — Customer &amp; Property CRM','canonical customer','snow clearing/removal','advisory only'],'Build 340 Help');
must(roadmap,['#### **340 — Customer & Property CRM** is implemented','#### 341 — Route Optimization & Territory Management','next planned autonomous item is **341 — Route Optimization & Territory Management**'],'Build 340 roadmap');
...
must(behavior,['boundary-exact-62-actions','boundary-build340-customer-property-crm'],'Boundary behavior advancement');
