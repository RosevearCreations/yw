...
addCheck('schema-header-current', /084_supervisor_attendance_review_and_execution_candidates/i.test(schema), 'Schema snapshot header should reflect the latest 084 pass.');
