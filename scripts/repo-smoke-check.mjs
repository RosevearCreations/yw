...
addCheck('admin-saved-filter-replays-staff-filters', adminUi.includes('people_search') && adminUi.includes('people_role_filter') && adminUi.includes('Loaded saved admin view with section and Staff Directory filters'), 'Saved admin filters should persist/replay Staff Directory filters.');
...
addCheck('active-docs-archived-snapshot', fileExists('archive/markdown-current-snapshot-2026-05-16b/root/README.md'), 'Archive snapshot should preserve the previous root README.');
