...
addCheck('schema-header-current', /118_admin_preflight_registry_deployment_checklist_ui/i.test(schema), 'Schema snapshot should reflect the latest 118 pass.');
...
addCheck('active-docs-archived-snapshot', fileExists('archive/markdown-current-snapshot-2026-05-20a/root/README.md'), 'Archive snapshot should preserve the previous root README for the current pass.');
...
addCheck('cache-version-2026-05-20a', read('server-worker.js').includes('2026-05-20a') && read('index.html').includes('2026-05-20a'), 'Index and service worker should use the 2026-05-20a asset/cache version.');
...
addCheck('active-docs-archived-snapshot-2026-05-20a-legacy-check', fileExists('archive/markdown-current-snapshot-2026-05-20a/root/README.md'), 'Archive snapshot should preserve the previous root README for the 2026-05-20a pass.');
...
addCheck('active-docs-archived-snapshot-2026-05-20a', fileExists('archive/markdown-current-snapshot-2026-05-20a/root/README.md'), 'Archive snapshot should preserve the previous root README for the 2026-05-20a pass.');
