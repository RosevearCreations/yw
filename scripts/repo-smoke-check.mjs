...
addCheck('cache-version-2026-06-12b', read('server-worker.js').includes('2026-06-12b') && read('index.html').includes('2026-06-12b'), 'Index and service worker should use the 2026-06-12b asset/cache version.');
...
addCheck('cache-version-2026-06-12b-latest', read('server-worker.js').includes('2026-06-12b') && read('index.html').includes('2026-06-12b'), 'Index and service worker should use the 2026-06-12b asset/cache version.');
...
addCheck('service-worker-caches-mobile-today', read('server-worker.js').includes('/js/mobile-today.js') && read('server-worker.js').includes('2026-06-12b'), 'Service worker should cache js/mobile-today.js with the latest cache version.');
...
addCheck('mobile-form-helper-cached', read('server-worker.js').includes('/js/mobile-form-helper.js') && read('server-worker.js').includes('2026-06-12b'), 'Service worker should cache js/mobile-form-helper.js with the latest cache version.');
...
addCheck('seo-assets-fresh-schema-144', read('sitemap.xml').includes('<lastmod>2026-06-12</lastmod>') && read('robots.txt').includes('Sitemap:'), 'sitemap.xml and robots.txt should remain fresh for schema 144.');
addCheck('cache-version-2026-06-12b-latest', read('server-worker.js').includes('2026-06-12b') && read('index.html').includes('2026-06-12b'), 'Index and service worker should use the 2026-06-12b asset/cache version.');
