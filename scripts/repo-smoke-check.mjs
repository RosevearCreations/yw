...
addCheck('cache-version-2026-06-09a', read('server-worker.js').includes('2026-06-09a') && read('index.html').includes('2026-06-09a'), 'Index and service worker should use the 2026-06-09a asset/cache version.');
...
addCheck('cache-version-2026-06-09a-latest', read('server-worker.js').includes('2026-06-09a') && read('index.html').includes('2026-06-09a'), 'Index and service worker should use the 2026-06-09a asset/cache version.');
...
addCheck('service-worker-caches-mobile-today', read('server-worker.js').includes('/js/mobile-today.js') && read('server-worker.js').includes('2026-06-09a'), 'Service worker should cache js/mobile-today.js with the latest cache version.');
...
addCheck('mobile-form-helper-cached', read('server-worker.js').includes('/js/mobile-form-helper.js') && read('server-worker.js').includes('2026-06-09a'), 'Service worker should cache js/mobile-form-helper.js with the latest cache version.');
