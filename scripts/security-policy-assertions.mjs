#!/usr/bin/env node
/** Source check plus optional service-role read of schema 153 policy assertions. */
import fs from 'node:fs';
import process from 'node:process';
const root=process.cwd();
const sql=fs.readFileSync('sql/153_release_fixture_policy_mapping_seo_alerts.sql','utf8');
