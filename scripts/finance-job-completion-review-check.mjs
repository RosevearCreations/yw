...
check('schema172-finance-ui-two-step',financeUi.includes("action:'dispose'")&&financeUi.includes("action:'generate_candidates'")&&financeUi.includes('Generate draft candidates')&&financeUi.includes('posting_authorized: false'));
