...
check('schema172-finance-ui-two-step',financeUi.includes("action:'dispose'")&&financeUi.includes("action:'generate_candidates'")&&financeUi.includes('Generate draft candidates')&&!financeUi.includes("action:'post_candidate'")&&financeUi.includes('Provider/payment mutation remains OFF'));
