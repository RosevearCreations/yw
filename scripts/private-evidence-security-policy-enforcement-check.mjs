...
add('help-documents-private-review-boundary', hasAll(help, ['private review media must stay internal', 'Only approved public media may appear on customer or public surfaces']), 'Online Help explains the review-to-public promotion boundary.');
add('handbook-documents-private-review-boundary', hasAll(handbook, ['## Private evidence and public media boundary', 'review-assets', 'public-assets']), 'The durable handbook records the private evidence security contract.');
