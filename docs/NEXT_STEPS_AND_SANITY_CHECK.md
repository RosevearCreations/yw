...
Items **318 — Job Cost & Profitability Closeout**, **319 — Landscaping Finance Dashboard & Cash Position**, **320 — Operations Needs Attention**, **321 — Crew Scheduling & Dispatch**, and **322 — Recurring Lawn & Yard Maintenance Engine** are implemented by the current release. The next planned autonomous item is **323 — Property & Site Intelligence**.
