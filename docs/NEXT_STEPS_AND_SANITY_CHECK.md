...
Items **318 — Job Cost & Profitability Closeout**, **319 — Landscaping Finance Dashboard & Cash Position**, and **320 — Operations Needs Attention** are implemented by the current release. The next planned autonomous item is **321 — Crew Scheduling & Dispatch**.
