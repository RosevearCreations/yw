...
This document summarizes the current intended schema for the YWI HSE system.

## Current schema status
- latest full reference snapshot: `sql/000_full_schema_reference.sql`
- latest live migration: `sql/055_storage_onboarding_identity_change_and_bootstrap.sql`
- current pass added no new schema migration; conflict-review UI and diagnostics timing were frontend/runtime improvements
