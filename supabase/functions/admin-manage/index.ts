  ...
  try {
    ...
    if (entity === 'linked_hse_packet') {
      const patch = {
        ...
        machinery_review_required: !!body.machinery_review_required,
        machinery_review_completed: !!body.machinery_review_completed,
        moving_blade_risk: !!body.moving_blade_risk,
        pinch_point_risk: !!body.pinch_point_risk,
        thrown_object_risk: !!body.thrown_object_risk,
        guard_controls_verified: !!body.guard_controls_verified,
        lockout_required: !!body.lockout_required,
        lockout_verified: !!body.lockout_verified,
        task_tool_risk_notes: body.task_tool_risk_notes ?? null,
        machinery_notes: body.machinery_notes ?? null,
        lifting_review_required: !!body.lifting_review_required,
        lifting_review_completed: !!body.lifting_review_completed,
        manual_handling_required: !!body.manual_handling_required,
        repetitive_motion_risk: !!body.repetitive_motion_risk,
        overhead_reach_risk: !!body.overhead_reach_risk,
        uneven_terrain_risk: !!body.uneven_terrain_risk,
        crew_lift_required: !!body.crew_lift_required,
        crew_size_notes: body.crew_size_notes ?? null,
        lifting_notes: body.lifting_notes ?? null,
        hydration_plan_notes: body.hydration_plan_notes ?? null,
        clothing_notes: body.clothing_notes ?? null,
        sun_air_movement_notes: body.sun_air_movement_notes ?? null,
        worker_specific_risk_notes: body.worker_specific_risk_notes ?? null,
        sds_notes: body.sds_notes ?? null,
        cones_barriers_required: !!body.cones_barriers_required,
        cones_barriers_completed: !!body.cones_barriers_completed,
        roadside_exposure_risk: !!body.roadside_exposure_risk,
        site_communication_notes: body.site_communication_notes ?? null,
    ...
    if (entity === 'hse_packet_event') {
      const patch = {
        ...
        hazard_category: body.hazard_category ?? 'general',
        ...
        lockout_verified: !!body.lockout_verified,
        task_tool_risk_notes: body.task_tool_risk_notes ?? null,
        manual_handling_level: body.manual_handling_level ?? null,
        manual_handling_required: !!body.manual_handling_required,
        repetitive_motion_risk: !!body.repetitive_motion_risk,
        overhead_reach_risk: !!body.overhead_reach_risk,
        uneven_terrain_risk: !!body.uneven_terrain_risk,
        crew_lift_required: !!body.crew_lift_required,
        crew_size_needed: asNullableNumber(body.crew_size_needed),
        posture_notes: body.posture_notes ?? null,
        humidity_percent: asNullableNumber(body.humidity_percent),
        sun_exposure_level: body.sun_exposure_level ?? null,
        air_movement_notes: body.air_movement_notes ?? null,
        clothing_notes: body.clothing_notes ?? null,
        hydration_verified: !!body.hydration_verified,
        worker_specific_risk_notes: body.worker_specific_risk_notes ?? null,
        ...
        cones_barriers_required: !!body.cones_barriers_required,
        cones_barriers_in_place: !!body.cones_barriers_in_place,
        roadside_exposure_risk: !!body.roadside_exposure_risk,
        site_communication_notes: body.site_communication_notes ?? null,
        public_interaction_notes: body.public_interaction_notes ?? null,
        notes: body.notes ?? null,
