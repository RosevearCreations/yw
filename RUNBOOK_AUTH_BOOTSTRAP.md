...
- Repo sync note: the scheduler Edge Function is intentionally configured with `verify_jwt = false` and validates a shared secret header in code; do not treat it like the auth/bootstrap functions.
