...
## Schema 102 test focus
- apply an AR payment application and confirm invoice/payment balances recompute
- apply an AP payment application and confirm bill/payment balances recompute
- inspect generated journal-line rows for a posted journal candidate
- review scored reconciliation matches for one reconciliation session
- move one sales tax filing through review/approve/file/pay
- move one payroll remittance run through review/approve/remit
- build one accountant handoff package and confirm package metadata is written
