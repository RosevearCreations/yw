...
## 2026-05-06 accounting-close end-to-end workflow pass
- Added migration `sql/102_accounting_close_end_to_end_workflow.sql`.
- Added AR/AP payment application structures and balance recompute support.
- Added generated journal-line directory, scored reconciliation matches, sales-tax/payroll review views, richer accountant handoff package data, and payment application dashboard rollups.
- Extended admin-manage, admin-directory, jobs-directory, VerifyDB, smoke check, and active documentation to schema 102.
