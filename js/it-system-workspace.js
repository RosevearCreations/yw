/* File: js/it-system-workspace.js
   Build 239 I.T. & System focused workspace.
   ...
   and navigates existing release/database/access/runtime sections. It creates no API,
...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:680px){.it-system-grid{grid-template-columns:1fr}.it-system-actions>*{flex:1 1 170px}}
    `;
  ...
  window.YWIITSystemWorkspace = Object.freeze({ render, build:BUILD });
})();
