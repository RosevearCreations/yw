      ...
      section.innerHTML = `
        ...
        <div class="admin-panel-block" style="margin-top:16px;">
          ...
          <div class="admin-hub-grid">
            ...
            <button class="admin-hub-card" type="button" data-admin-route="reports"><strong>Historical Reports</strong><span>Pull date-filtered HSE, payroll, scheduler, and contract history with export-ready tables.</span><em>New</em></button>
