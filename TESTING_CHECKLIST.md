...
## 2026-06-11a / Schema 142 testing checklist

- Run `node scripts/repo-smoke-check.mjs`.
- Confirm schema 142 and schema 142 checks appear before the final smoke result.
- Confirm CSS brace balance remains zero.
- Confirm public pages have no more than one H1.
- Confirm `sitemap.xml` lastmod is `2026-06-11`.
- Confirm `index.html` and `server-worker.js` use `2026-06-11a`.
