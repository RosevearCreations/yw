...
- Latest pass adds workflow enforcement on top of the operations/accounting backbone: rollups, payment posting balance updates, receipt-to-costing linkage, and linked HSE packet closeout support.
- The repo continues moving toward one DB-backed source of truth for shared operations, accounting-ready records, and HSE linkage while preserving standalone safety workflows.
