-- Last synchronized: May 27, 2026. Reviewed during the mobile Today dashboard, PWA install helper, and offline queue badge pass.
-- Current reference remains aligned through 121_mobile_today_dashboard_pwa_and_offline_badges.sql.
