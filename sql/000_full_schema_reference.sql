-- Last synchronized: June 2, 2026. Reviewed during the roadmap depth, data migration, SEO/CSS, fallback guardrail, and schema 126 pass.
-- Current reference remains aligned through 126_roadmap_depth_data_migration_seo_css_fallback_guardrails.sql.
