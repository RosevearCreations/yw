-- Last synchronized: May 19, 2026. Reviewed during the Admin diagnostics drawer, stale badge, and persisted panel failure pass.
-- Current reference remains aligned through 116_admin_diagnostics_drawer_and_stale_data_badges.sql.
