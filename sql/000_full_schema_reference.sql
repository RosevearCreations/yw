-- Last synchronized: April 17, 2026. Reviewed during the recurring agreements, payroll, asset history, and login tracking pass.
-- Current reference remains aligned through 080_service_agreements_assets_payroll_and_login_tracking.sql.
