-- Last synchronized: May 29, 2026. Reviewed during the equipment transfer, arrival verification, return signoff, accounting-depth, and SEO smoke-check pass.
-- Current reference remains aligned through 123_equipment_transfer_arrival_return_accounting_seo_guardrails.sql.
