-- Last synchronized: June 1, 2026. Reviewed during the deployment bundle parse, SEO/local wording, fallback guardrail, and schema 125 pass.
-- Current reference remains aligned through 125_deployment_bundle_parse_seo_fallback_guardrails.sql.
