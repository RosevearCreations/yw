-- Last synchronized: May 18, 2026. Reviewed during the Admin panel retry, timing, and command-center fast path pass.
-- Current reference remains aligned through 115_admin_panel_retry_timing_and_command_scope.sql.
