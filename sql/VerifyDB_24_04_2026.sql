...
-- Schema 102 accounting-close end-to-end workflow checks
select to_regclass('public.ar_payment_applications') as ar_payment_applications;
select to_regclass('public.ap_payment_applications') as ap_payment_applications;
select to_regclass('public.v_ar_payment_application_directory') as v_ar_payment_application_directory;
select to_regclass('public.v_ap_payment_application_directory') as v_ap_payment_application_directory;
select to_regclass('public.v_gl_journal_generated_line_directory') as v_gl_journal_generated_line_directory;
select to_regclass('public.v_bank_reconciliation_match_scored_directory') as v_bank_reconciliation_match_scored_directory;
select to_regclass('public.v_sales_tax_filing_review_directory') as v_sales_tax_filing_review_directory;
select to_regclass('public.v_payroll_remittance_review_directory') as v_payroll_remittance_review_directory;
select to_regclass('public.v_accountant_handoff_package_directory') as v_accountant_handoff_package_directory;
select to_regclass('public.v_accounting_payment_application_dashboard') as v_accounting_payment_application_dashboard;
