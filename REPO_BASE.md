...
- Core repo change this pass: workflow math and progress rules are being pulled out of ad hoc UI behavior and into repeatable database / function logic.
- Keep schema snapshots, migration order, Admin UI controls, and smoke checks aligned every pass.
