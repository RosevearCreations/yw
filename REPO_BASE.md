...
Canonical SQL chain now runs through schema 102. The full schema snapshot, VerifyDB script, and repo smoke check were synced in this pass and fixed-copy schema files remain retired from the active repo.
